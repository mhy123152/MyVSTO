                ...
                */
                ...
                switch (dict["work_class"])
                {
                    case "事业管理":
                        ...
                        templateDocument.Variables.Add("tx_level_1", dict["work_level"]);
                    ...
                    case "事业专技":
                        ...
                        templateDocument.Variables.Add("tx_level_2", dict["work_level"]);
                    ...
                    case "事业工勤":
                        ...
                        templateDocument.Variables.Add("tx_level_3", dict["work_level"]);
                ...
                for (int i = 2; i <= dataRange.Rows.Count; i++)
                {
                    if (dataRange.Cells[i, 2].Text == dict["id"])
                    {
                        ...
                        for (int j = 1; j <= 5; j++)
                        {
                            templateDocument.Variables.Add($"r{dataRowNum}c{j}", dataRange.Cells[i, 4+j].Text);
                        }

                        //根据工作经历来计算合计缴费月数
                        pay_age += int.Parse(dataRange.Cells[i, 9].Text);
